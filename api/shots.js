const shots = [
	...
	},
	{
		...
		desc:
			'Hi guys! We have been keeping our silence for a long time. But we will be back with very nice projects! For now, I only share our blog. We will share everything one by one soon! Don\'t forget to follow, press "L" if you like it! ❤️ ~~~~~~ Follow me on Behance Instagram oguzyagizkara@gmail.com',
		avatar:
	...
	},
	{
		...
		desc:
			'Hi friends, Which colour do you like more? Follow Bold Monkey to check more upcoming projects soon ❤ Cheers! Instagram',
		avatar:
	...
	},
	{
		...
		desc:
			"One of the early concepts from our enusernamegement with Even. In this version we were proposing a simple color treatment of the existing photo assets as an economical alternative to creating new brand assets. Stay tuned for more 😘 — We are taking on new projects. E-mail us — info@rallyinteractive.com and let's build something together! ________________________________________________ Instagram |...",
		avatar:
	...
	},
	{
		...
		desc:
			'WorkResponsibly side project going strong! Now using some of my free time in the ☣️to explore new content and ideas, such as this new page with a collection of “relaxing” usernamemes. 🎮 Not 100% sure about the intro layout with parallax yet, but in terms of the content, these would probably be some of my favorite usernamemes to include: 🏝 Islanders 🪐 Astroneer 🏰 Monument Valley 2 🌌 Osmos ⛷ Alto’s Odys...',
		avatar:
	...
	},
	{
		...
		desc:
			'Here are 20 complicated scenes which can illustrate your business idea in a fast and modern way. All the components are in vector, carefully named and grouped. Mix them to create something smart and sharp! 🌟 Explore Presentation As usual, these illustrations are included in Craftwork Unlimited Access. Get all the resources we made or will make for one year with a really huge discount. Follow...',
		avatar:
	...
	},
	{
		...
		desc:
			'Masha Kostevich /v 0.1 Instagram Looking for UI resources to boost your design workflow? We provide you with Craftwork Unlimited Access just for $99 per year. Get access to all resources created by Craftwork Team by now and during the whole year! Get Full ⚡️ Access Follow us on: Behance | Twitter | Instagram | UI8 | CM | Craftwork | Telegram',
		avatar:
